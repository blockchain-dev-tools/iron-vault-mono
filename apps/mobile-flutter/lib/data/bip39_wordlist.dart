...
///
/// Standard wordlist defined in BIP-39 for mnemonic generation.
/// Index positions correspond to 11-bit chunks of entropy.
const List<String> bip39English = [
  ...
  'invest', 'invite', 'involve', 'island', 'isolate', 'issue', 'item', 'ivory',
...
const List<String> bip39ChineseSimplified = [
  '的',
  '一',
  '是',
  '在',
...
enum Bip39WordlistLanguage {
  english,
  chineseSimplified,
}

/// Returns the display name for a wordlist language.
String bip39LanguageName(Bip39WordlistLanguage lang) {
  switch (lang) {
...
List<String> bip39Wordlist(Bip39WordlistLanguage lang) {
  switch (lang) {
    case Bip39WordlistLanguage.english:
      return bip39English;
    case Bip39WordlistLanguage.chineseSimplified:
