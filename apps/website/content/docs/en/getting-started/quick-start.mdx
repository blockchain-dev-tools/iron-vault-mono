---
title: "Quick Start"
description: "Connect to IRON Vault via BLE and send your first APDU command in 5 minutes."
---

## Prerequisites

- Chrome browser with `chrome://flags/#enable-experimental-web-platform-features` enabled
- IRON Vault app running on an Android device, or use the **Simulator** on this site
