export const EN = {
  ...
  vault: {
    ...
    hdBadge: 'HD',
    hardwareLinked: 'Hardware Vault Linked',
    bleEncrypted: 'BLUETOOTH ACTIVE • ENCRYPTED',
    ethLabel: 'Ethereum',
    ...
    okxStep1: 'In OKX, tap「Wallet」→「Add Wallet」',
    ...
    bleConnectedSub: 'OKX has connected to this device',
    bleBroadcastingSub: 'Waiting for OKX to connect',
  ...
  transaction: {
    ...
    successTitle: 'Signed',
    successSub: 'Transaction sent back to OKX.',
    return: 'Return',
  },
  nav: {
    vault: 'Vault',
